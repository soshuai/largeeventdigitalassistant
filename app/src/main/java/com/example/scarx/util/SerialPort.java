 ...
 */
package com.example.scarx.util;
...
//    private final FileWriter uartIdleControl;
//
//    {
//        try {
//            uartIdleControl = new FileWriter("sys/devices/platform/11002000.serial/uart_idle_control");
//        } catch (IOException e) {
...
//
//        uartIdleControl.write(1);
//        uartIdleControl.flush();
//    }
...
//        close();
//        try {
//            uartIdleControl.write(0);
//            uartIdleControl.flush();
//            uartIdleControl.close();
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
//    }
...
//    }
    ...
    /**
     * echo 1 > sys/devices/platform/scan_power_control_gpio/scan_power_control 上电
     * echo 0 > sys/devices/platform/scan_power_control_gpio/scan_power_control 下电
     * <p>
     * echo 1 > sys/devices/platform/scan_power_control_gpio/scan_trigger_aim_on 扫码头出光
     * echo 0 > sys/devices/platform/scan_power_control_gpio/scan_trigger_aim_on 扫码头灭光
     */
    ...
    public void rfid_poweron() {
        rfid_5v_en_on();
        rfid2_power_control_on();
    }

    public void rfid_poweroff() {
        rfid_5v_en_off();
        rfid2_power_control_off();
    }

    public boolean DCENon() {
        return dc_en_on();
    }

    public boolean DCENoff() {
       return dc_en_off();
    }
    ...
    private boolean scanertrigeron() {
        try {
            FileWriter fileWriter = new FileWriter("sys/devices/platform/scan_power_control_gpio/scan_trigger_aim_on");
            fileWriter.write("1");
            fileWriter.close();
        } catch (IOException e) {
            return false;
    ...
    private boolean scanertrigeroff() {
        try {
            FileWriter fileWriter = new FileWriter("sys/devices/platform/scan_power_control_gpio/scan_trigger_aim_on");
            fileWriter.write("0");
            fileWriter.close();
    ...
    private boolean scanerpoweron() {
        try {
            FileWriter fileWriter = new FileWriter("sys/devices/platform/scan_power_control_gpio/scan_power_control");
            fileWriter.write("1");
            fileWriter.close();
        } catch (IOException e) {
            return false;
    ...
    private boolean scanerpoweroff() {
        try {
            FileWriter fileWriter = new FileWriter("sys/devices/platform/scan_power_control_gpio/scan_power_control");
            fileWriter.write("0");
            fileWriter.close();
    ...
    private boolean rfid2_power_control_on() {
        try {
            FileWriter fileWriter = new FileWriter("sys/devices/platform/module_power/rfid2_power_control");
            fileWriter.write("1");
            fileWriter.close();
        } catch (IOException e) {
            return false;
    ...
    private boolean rfid2_power_control_off() {
        try {
            FileWriter fileWriter = new FileWriter("sys/devices/platform/module_power/rfid2_power_control");
            fileWriter.write("0");
            fileWriter.close();
    ...
    private boolean rfid_5v_en_on() {
        try {
            FileWriter fileWriter = new FileWriter("sys/devices/platform/module_power/rfid_5v_en");
            fileWriter.write("1");
            fileWriter.close();
        } catch (IOException e) {
            return false;
    ...
    private boolean rfid_5v_en_off() {
        try {
            FileWriter fileWriter = new FileWriter("sys/devices/platform/module_power/rfid_5v_en");
            fileWriter.write("0");
            fileWriter.close();
    ...
    private boolean dc_en_on() {
        try {
            FileWriter fileWriter = new FileWriter("sys/devices/platform/module_power/dc_en");
            fileWriter.write("1");
            fileWriter.close();
        } catch (IOException e) {
            return false;
